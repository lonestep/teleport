...
namespace TLP
{
	...
	public:
		//
		// strChannelName [IN]: Arbitary ansic string indicating the channel, without slash "\\". 
		//                      no more than MAX_NAME characters.
		// 
		...
		//
		// nChannelId: Same us the previous version of Publish( strChannelName,...), 
		// this function will be more efficient if you have already know the channel id.
		//
